...
export default function SetTheme() {
  ...
  const [route, wasRoute] = useState(null);
  ...
  const buttonIcon = (theme) => {
    if (theme == "light") {
      // Show moon — clicking will switch to dark
      return (
      ...
      // Show sun — clicking will switch to light
      return (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  const defaultTheme = () => {
    ...
    // If user had unicorn saved, reset to light
    if (saved === "unicorn") {
